...
export function generateMetadata(): Metadata {
  ...
  const title = `Cheap Flights to Singapore ${year} — Guide, Prices & Attractions | Flyamba`;
  const description = `Find cheap flights to Singapore from ${usdStr(LOWEST_SEK)}. Compare fares, plus complete English guides to attractions, restaurants, hotels, transport, weather, shopping, beaches, nightlife, family travel and day trips.`;
...
function jsonLd() {
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Asia" },
      { "@type": "ListItem", position: 3, name: "Singapore", item: url },
    ],
  };
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative isolate h-[80vh] min-h-[560px] w-full overflow-hidden">
        <SmartImage src={CITY.hero} alt="Cheap flights to Singapore" fill priority sizes="100vw" className="object-cover" />
      ...
      <section className="mx-auto mt-12 max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            { icon: Route, label: "Direct flights", value: "Yes — a global hub at Changi" },
          ].map((s) => (

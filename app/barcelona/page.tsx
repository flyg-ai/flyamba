  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section id="flights" className="mx-auto mt-10 max-w-7xl scroll-mt-32 px-4 sm:px-6 lg:px-8">
        ...
        <p className="mb-6 max-w-3xl text-muted-foreground">Flying to Barcelona is easier than ever, with direct routes from New York, London and other major hubs — making Barcelona one of the most popular flight destinations from the US, UK and Europe. Find cheap flights to Barcelona, compare airlines and book direct. Our AI flight search compares hundreds of routes to find you the cheapest flights to Barcelona — just describe your trip and Flyamba does the rest.</p>

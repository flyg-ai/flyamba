  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative isolate h-[80vh] min-h-[560px] w-full overflow-hidden">
        ...
        <SmartImage src={CITY.hero} fallback={CITY.heroFallback} alt="Cheap flights to Athens, Greece" fill fetchPriority="high" loading="eager" sizes="100vw" className="object-cover" />
        ...
        <div className="relative z-10 mx-auto flex h-full max-w-7xl flex-col justify-end px-4 pb-14 pt-24 sm:px-6 lg:px-8">
          ...
          <div className="mb-4">
            <Breadcrumbs onDark items={crumbsForSlug("athens")} />
          </div>
      ...
      <section id="flights" className="mx-auto mt-10 max-w-7xl scroll-mt-32 px-4 sm:px-6 lg:px-8">
        ...
        <p className="mb-6 max-w-3xl text-muted-foreground">Athens is reachable from the US, the UK and across Europe, though whether a given route is non-stop depends on your airport and the season. Find cheap flights to Athens, compare airlines and book direct. Our AI flight search compares hundreds of routes to find you the cheapest flights to Athens — just describe your trip and Flyamba does the rest.</p>
        ...
        <NonstopRoutes slug="athens" name="Athens" iata="ATH" />
      ...
      <section className="mx-auto mt-16 max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <h2 className="mt-2 font-serif text-3xl font-semibold text-foreground sm:text-4xl">Why Fly to Athens with Flyamba?</h2>
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {WHY.map((w) => (
      ...
      <GuidesCarousel
        ...
        guides={getGuidesByDestination("athens").slice(0, 3)}

        title="Latest Athens guides"

...
export const destinations: Destination[] = [
  {
    ...
    thingsToDo: [
      { title: "Sagrada Família", desc: "Gaudí's unfinished basilica — a century in the making.", image: "https://images.unsplash.com/photo-1583779457094-ab6f8be4a1c8?auto=format&fit=crop&w=800&q=80" },
      { title: "Park Güell", desc: "Mosaic terraces with sweeping views of the city.", image: "https://images.unsplash.com/photo-1509840841025-9088ba78a826?auto=format&fit=crop&w=800&q=80" },
      { title: "La Boqueria", desc: "Sensory-overload food market off Las Ramblas.", image: "https://images.unsplash.com/photo-1555992336-fb0d29498b13?auto=format&fit=crop&w=800&q=80" },
      { title: "Barceloneta Beach", desc: "Golden sand a short metro ride from the Gothic Quarter.", image: "https://images.unsplash.com/photo-1591792063115-a3e10eaa6a4b?auto=format&fit=crop&w=800&q=80" },
    ],
    summerTemp: 27,
    ...
    neighborhoods: [
      {
        ...
        image: "https://images.unsplash.com/photo-1580746738099-1a6b8a86e8a1?auto=format&fit=crop&w=800&q=80",
      },
      {
        name: "Eixample",
        ...
        image: "https://images.unsplash.com/photo-1573155993874-d5d48af862ba?auto=format&fit=crop&w=800&q=80",
      },
      {
        name: "El Born",
      ...
      },
      {
        ...
        image: "https://images.unsplash.com/photo-1591792063115-a3e10eaa6a4b?auto=format&fit=crop&w=800&q=80",
      },
    ],
    restaurants: [
    ...
    dayTrips: [
      {
        ...
        image: "https://images.unsplash.com/photo-1583776499128-3b6ddbe73d15?auto=format&fit=crop&w=800&q=80",
      },
      {
        name: "Sitges",
        distance: "40 km SW",
        ...
        image: "https://images.unsplash.com/photo-1591780980665-a3d5d9c66d3d?auto=format&fit=crop&w=800&q=80",
      },
      {
        name: "Girona",
        distance: "100 km NE",
        ...
        image: "https://images.unsplash.com/photo-1596394723269-b2cbca4e6e33?auto=format&fit=crop&w=800&q=80",
      },
    ],
    events: [
  ...
  },
  {
    ...
    thingsToDo: [
      { title: "Shibuya Crossing", desc: "The world's busiest intersection at neon golden hour.", image: "https://images.unsplash.com/photo-1554797589-7241bb691973?auto=format&fit=crop&w=800&q=80" },
      { title: "Senso-ji Temple", desc: "Ancient temple in the heart of Asakusa.", image: "https://images.unsplash.com/photo-1583400977900-a91fd0e2b1a6?auto=format&fit=crop&w=800&q=80" },
      { title: "Tsukiji Outer Market", desc: "Sushi breakfasts and knife shops.", image: "https://images.unsplash.com/photo-1526318472351-c75fcf070305?auto=format&fit=crop&w=800&q=80" },
    ],
  },
  {
    slug: "lisbon",
    ...
    thingsToDo: [
      { title: "Alfama", desc: "Fado music in the oldest quarter.", image: "https://images.unsplash.com/photo-1588535593760-1f5f16dc9e77?auto=format&fit=crop&w=800&q=80" },
      { title: "Tram 28", desc: "Vintage yellow tram climbing the seven hills.", image: "https://images.unsplash.com/photo-1513735492246-483525079686?auto=format&fit=crop&w=800&q=80" },
      { title: "Belém", desc: "Custard tarts, monasteries, and river views.", image: "https://images.unsplash.com/photo-1541618338-236b90ec4b8f?auto=format&fit=crop&w=800&q=80" },
    ],
  },
  {
    slug: "new-york",
    ...
    thingsToDo: [
      { title: "Central Park", desc: "843 acres of green in the middle of Manhattan.", image: "https://images.unsplash.com/photo-1518391846015-55a9cc003b25?auto=format&fit=crop&w=800&q=80" },
      { title: "MoMA", desc: "Modern art heavyweight collection.", image: "https://images.unsplash.com/photo-1554907984-15263bfd63bd?auto=format&fit=crop&w=800&q=80" },
      { title: "Brooklyn Bridge", desc: "Sunset walk with the skyline behind you.", image: "https://images.unsplash.com/photo-1524293581917-878a6d017c71?auto=format&fit=crop&w=800&q=80" },
    ],
  },
  {
    slug: "bali",
    ...
    thingsToDo: [
      { title: "Ubud", desc: "Jungle spas, cafés, and monkey forests.", image: "https://images.unsplash.com/photo-1531592937781-344ad608fabf?auto=format&fit=crop&w=800&q=80" },
      { title: "Tegallalang", desc: "Iconic emerald rice terraces.", image: "https://images.unsplash.com/photo-1573790387438-4da905039392?auto=format&fit=crop&w=800&q=80" },
      { title: "Uluwatu", desc: "Cliff temple at sunset with kecak dance.", image: "https://images.unsplash.com/photo-1518439999979-4a51b1c4f2ff?auto=format&fit=crop&w=800&q=80" },
    ],
  },
  {
    slug: "cape-town",
    ...
    thingsToDo: [
      { title: "Table Mountain", desc: "Cable car up, hike down through fynbos.", image: "https://images.unsplash.com/photo-1580060839134-75a5edca2e99?auto=format&fit=crop&w=800&q=80" },
      { title: "Cape Point", desc: "Where two oceans meet the wild coast.", image: "https://images.unsplash.com/photo-1516026672322-bc52d61a55d5?auto=format&fit=crop&w=800&q=80" },
      { title: "Bo-Kaap", desc: "Rainbow-colored houses in the Cape Malay quarter.", image: "https://images.unsplash.com/photo-1611746872915-64382b5c76da?auto=format&fit=crop&w=800&q=80" },
    ],
  },
  {
    slug: "reykjavik",
    ...
    thingsToDo: [
      { title: "Blue Lagoon", desc: "Milky geothermal waters against black lava.", image: "https://images.unsplash.com/photo-1520769945061-0a448c463865?auto=format&fit=crop&w=800&q=80" },
      { title: "Golden Circle", desc: "Geysers, waterfalls, and rift valleys.", image: "https://images.unsplash.com/photo-1531168556467-80aace0d0144?auto=format&fit=crop&w=800&q=80" },
    ],
  },
  {
    slug: "marrakech",
    ...
    tpName: "marrakech_ma",
    price: 2190,
    image: "https://images.unsplash.com/photo-1597211684565-dca64d72bdfe?auto=format&fit=crop&w=1600&q=80",
    ...
    thingsToDo: [
      { title: "Jemaa el-Fnaa", desc: "Storytellers, food stalls, and the call to prayer.", image: "https://images.unsplash.com/photo-1489749798305-4fea3ae63d43?auto=format&fit=crop&w=800&q=80" },
      { title: "Majorelle Garden", desc: "Cobalt-blue oasis once owned by YSL.", image: "https://images.unsplash.com/photo-1553603227-2358aabe821e?auto=format&fit=crop&w=800&q=80" },
    ],
  },
];

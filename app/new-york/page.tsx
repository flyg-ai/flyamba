...
function jsonLd() {
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "United States" },
      { "@type": "ListItem", position: 3, name: "New York", item: url },
    ],
  };
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative isolate h-[80vh] min-h-[560px] w-full overflow-hidden">
        <SmartImage src={HERO} alt="Cheap flights to New York, USA" fill priority sizes="100vw" className="object-cover" />

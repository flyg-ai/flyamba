  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative isolate h-[80vh] min-h-[560px] w-full overflow-hidden">
        ...
        <SmartImage src={HERO} alt="Cheap flights to Tenerife, Spain" fill fetchPriority="high" loading="eager" sizes="100vw" className="object-cover" />
        ...
        <div className="relative z-10 mx-auto flex h-full max-w-7xl flex-col justify-end px-4 pb-14 pt-24 sm:px-6 lg:px-8">
          ...
          <div className="mb-4">
            <Breadcrumbs onDark items={crumbsForSlug("tenerife")} />
          </div>
      ...
      <section className="mx-auto mt-16 max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <h2 className="mt-2 font-serif text-3xl font-semibold text-foreground sm:text-4xl">Why Fly to Tenerife with Flyamba?</h2>
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {WHY.map((w) => (

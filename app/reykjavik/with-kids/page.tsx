...
export default function ReykjavikWithKids() {
  return (
    ...
    >
      ...
      <CategorySeoSections heading="Reykjavik family attractions in detail" items={WITH_KIDS} />
    </CityGuideShell>
  );
}

...
const INFO: BcnPlace[] = [
  ...
  },
  {
    ...
    filterKeys: [],
    description: "A rental car isn't needed in Reykjavik itself but is the best way to explore Iceland's nature at your own pace.",
  ...
  },
  {
    ...
    filterKeys: [],
    description: "Reykjavik is small and relatively bike-friendly, with scenic waterfront cycle paths, best enjoyed in the milder months.",
...
export default function ReykjavikTransport() {
  return (
    <CityGuideShell
      ...
      active="transport"
      crumb="Transport"
      h1="Getting Around Reykjavik"
      heroImage={IMG}
      intro="Reykjavik is one of the easiest cities to navigate: a compact, walkable centre where almost everything is within a 25-minute stroll, backed by the Flybus from Keflavík airport, the Strætó city buses and — for exploring Iceland's nature beyond the city — rental cars and organised tours. This guide covers every option, from the 45-minute airport transfer and how the bus tickets work to car hire for day trips, cycling and when a taxi is worth it, with USD prices and money-saving tips."
      wide
    >
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd()).replace(/</g, "\\u003c") }} />
      <CategorySeoSections heading="Getting around Reykjavik — in detail" items={INFO} />
    </CityGuideShell>
  );
}

...
const INFO: BcnPlace[] = [
  {
    name: "Flight prices to Reykjavik", slug: "flight-prices", image: IMG, rating: 5, area: "KEF · round trip",
    tip: "Book 4–6 weeks ahead and fly Monday or Tuesday for the lowest fares to Keflavík.",
    filterKeys: [],
    description: `Round-trip fares to Reykjavik Keflavík start from around $${MIN_USD} and peak in mid-summer.`,
  ...
  },
  {
    ...
    filterKeys: [],
    description: "Accommodation is a major cost in Reykjavik; expect $200+ for a decent central double.",

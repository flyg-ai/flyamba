...
export const metadata: Metadata = {
  title: "Reykjavík Weather 2026 — Best Time to Visit & What to Pack",
  description:
    "Reykjavík weather season by season — temperatures, daylight, the midnight sun and northern lights, and what to pack, plus the best time to visit for…",
  alternates: { canonical: `${SITE}/reykjavik/weather` },
  openGraph: { title: "Reykjavík Weather & Best Time to Visit | Flyamba", description: "Season-by-season temperatures, daylight and packing tips for Reykjavík.", type: "article" },
};
...
const INFO: BcnPlace[] = [
  {
    name: "Reykjavík's climate in a nutshell", slug: "climate-overview", image: IMG, rating: 5, area: "Year-round",
    tip: "The Icelandic saying holds: 'If you don't like the weather, wait five minutes.' Pack waterproof layers whatever the month.",
    filterKeys: [],
    description: "Reykjavík has a cool, wet and famously changeable maritime climate, milder than its latitude suggests thanks to the Gulf Stream.",
    practicalInfo: { openingHours: "N/A", price: "N/A", howToGetThere: "Summer highs ~10–14°C; winter ~0 to 3°C; wind and rain year-round" },
    fullDescription: "Despite sitting just below the Arctic Circle, Reykjavík has a surprisingly mild — if cool, wet and wildly changeable — maritime climate, kept from real extremes by the warming influence of the Gulf Stream. Summers are cool rather than warm, with daytime highs typically around 10 to 14°C in July and August, while winters are cold but rarely brutal, hovering around 0 to 3°C with only intermittent frost and snow in the city itself. The defining features aren't temperature but wind, rain and light: the weather changes constantly, it's common to get sun, cloud, rain and wind in a single hour, and the wind off the North Atlantic can make it feel far colder than the thermometer says. Rainfall is spread across the year, with autumn and winter the wettest and windiest. The two great natural spectacles are seasonal — the midnight sun around the summer solstice, when it barely gets dark, and the northern lights on clear nights from September to March. The practical upshot: whenever you visit, pack warm, waterproof, windproof layers, and don't count on sunshine. Download the Icelandic weather app Veður, as conditions shift fast.",
  },
  {
  ...
  },
  {
    ...
    fullDescription: "Winter is Reykjavík at its darkest, coldest and most atmospheric — and, for aurora-chasers, most rewarding. Daytime highs hover around 0 to 3°C, and the days are very short, with as little as four to five hours of daylight around the December solstice, so you plan sightseeing for the middle of the day and evenings around cosy cafés, geothermal pools and the northern lights. This is peak aurora season, when long, dark nights give the best chance of seeing the lights dance overhead on clear nights — head out of the city to escape the light pollution, or take a guided tour, and check the aurora forecast. Snow dusts the streets and the surrounding mountains, and the run-up to Christmas and New Year brings festive lights, markets and Reykjavík's famously explosive New Year's Eve fireworks. Outside that holiday peak, winter is the cheapest time to visit, with February and November the lowest months for flights and hotels. The keys are to dress for the cold and dark — warm coat, hat, gloves, waterproof boots and layers — to build days around indoor sights and hot pools, and to allow flexibility, as storms can close roads. For budget travellers and aurora seekers who don't mind bundling up, winter is magical.",
  },
  {
...
export default function ReykjavikWeather() {
  return (
    <CityGuideShell
      ...
      active="weather"
      crumb="Weather"
      h1="Reykjavík Weather & Best Time to Visit"
      heroImage={IMG}

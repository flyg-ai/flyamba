    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative isolate h-[80vh] min-h-[560px] w-full overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex h-full max-w-7xl flex-col justify-end px-4 pb-14 pt-24 sm:px-6 lg:px-8">
          ...
          <div className="mb-4">
            <Breadcrumbs onDark items={crumbsForSlug("cape-town")} />
          </div>
      ...
      <section id="flights" className="mx-auto mt-10 max-w-7xl scroll-mt-32 px-4 sm:px-6 lg:px-8">
        ...
        <p className="mb-6 max-w-3xl text-muted-foreground">Cape Town is reachable from the US, the UK and across Europe, though whether a given route is non-stop depends on your airport and the season. Find cheap flights to Cape Town, compare airlines and book direct. Our AI flight search compares hundreds of routes to find you the cheapest flights to Cape Town — just describe your trip and Flyamba does the rest.</p>

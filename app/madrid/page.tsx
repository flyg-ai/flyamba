...
export function generateMetadata(): Metadata {
  ...
  const title = `Cheap Flights to Madrid ${year} — Guide, Prices & Attractions | Flyamba`;
  const description = `Find cheap flights to Madrid, Spain from $${MIN_USD}, plus complete English guides to attractions, restaurants, hotels, transport, weather, shopping, nightlife, family travel and day trips. World-class art, tapas and nightlife until dawn.`;
...
function jsonLd() {
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Madrid", item: url },
    ],
  };
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative isolate h-[80vh] min-h-[560px] w-full overflow-hidden">
        <SmartImage src={HERO} alt="Cheap flights to Madrid, Spain" fill priority sizes="100vw" className="object-cover" />

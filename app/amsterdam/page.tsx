  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section id="flights" className="mx-auto mt-10 max-w-7xl scroll-mt-32 px-4 sm:px-6 lg:px-8">
        ...
        <p className="mb-6 max-w-3xl text-muted-foreground">Amsterdam is reachable from the US, the UK and across Europe, though whether a given route is non-stop depends on your airport and the season. Find cheap flights to Amsterdam, compare airlines and book direct. Our AI flight search compares hundreds of routes to find you the cheapest flights to Amsterdam — just describe your trip and Flyamba does the rest.</p>

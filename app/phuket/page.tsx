...
function jsonLd() {
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Phuket", item: url },
    ],
  };
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative isolate h-[80vh] min-h-[560px] w-full overflow-hidden">
        <SmartImage src={CITY.hero} alt="Cheap flights to Phuket, Thailand" fill priority sizes="100vw" className="object-cover" />
      ...
      <section className="mx-auto mt-12 max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            { icon: Route, label: "Direct flights", value: "Bangkok, Singapore, Dubai + more" },
          ].map((s) => (

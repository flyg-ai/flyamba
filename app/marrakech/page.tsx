...
export function generateMetadata(): Metadata {
  ...
  const title = `Cheap Flights to Marrakech ${year} — Guide, Prices & Attractions | Flyamba`;
  const description = `Find cheap flights to Marrakech, Morocco from ${usdStr(LOWEST_SEK)}. Compare fares, plus complete English guides to attractions, restaurants, riads, transport, weather, shopping, beaches, nightlife, family travel and Atlas day trips.`;
...
function jsonLd() {
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Morocco" },
      { "@type": "ListItem", position: 3, name: "Marrakech", item: url },
    ],
  };
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative isolate h-[80vh] min-h-[560px] w-full overflow-hidden">
        <SmartImage src={CITY.hero} alt="Cheap flights to Marrakech, Morocco" fill priority sizes="100vw" className="object-cover" />

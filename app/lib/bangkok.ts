...
export const BANGKOK_CATEGORIES: BangkokCategory[] = [
  ...
  { slug: "restaurants", label: "Restaurants", emoji: "🍽️", blurb: "Street food legends to three-Michelin-star tables.", image: "/images/bangkok/restaurants/restaurant-bangkok.avif" },
  { slug: "hotels", label: "Hotels", emoji: "🏨", blurb: "Riverside grandes dames, boutiques and hostels.", image: "/images/bangkok/hotels/hotel-bangkok.avif" },
  ...
  { slug: "shopping", label: "Shopping", emoji: "🛍️", blurb: "Mega-malls, weekend markets and silk.", image: "/images/bangkok/shopping/artisan-shop-bangkok.webp" },
  ...
  { slug: "nightlife", label: "Nightlife", emoji: "🌙", blurb: "Sky-high rooftop bars, speakeasies and clubs.", image: "/images/bangkok/nightlife/cocktail-bar-bangkok.webp" },

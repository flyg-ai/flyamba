...
export function AviasalesWidget({ toName, fromName }: Props) {
  ...
  useEffect(() => {
    ...
    script.src = `https://tpwdg.com/content?currency=usd&trs=563187&shmarker=711264.flyamba&powered_by=false&locale=en&${fromParam}to_name=${toName}&show_header=true&searchUrl=search.jetradar.com&campaign_id=111&promo_id=4478&limit=5`;
    script.async = true;

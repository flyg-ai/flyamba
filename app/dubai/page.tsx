  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative isolate h-[80vh] min-h-[560px] w-full overflow-hidden">
        ...
        <SmartImage src={HERO} alt="Cheap flights to Dubai, United Arab Emirates" fill fetchPriority="high" loading="eager" sizes="100vw" className="object-cover" />
        ...
        <div className="relative z-10 mx-auto flex h-full max-w-7xl flex-col justify-end px-4 pb-14 pt-24 sm:px-6 lg:px-8">
          ...
          <div className="mb-4">
            <Breadcrumbs onDark items={crumbsForSlug("dubai")} />
          </div>
      ...
      <section id="flights" className="mx-auto mt-10 max-w-7xl scroll-mt-32 px-4 sm:px-6 lg:px-8">
        ...
        <NonstopRoutes slug="dubai" name="Dubai" iata="DXB" />
      ...
      <GuidesCarousel
        ...
        guides={getGuidesByDestination("dubai").slice(0, 3)}


        title="Latest Dubai guides"

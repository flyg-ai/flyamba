...
export function generateMetadata(): Metadata {
  ...
  const title = `Cheap Flights to Florence ${year} — Guide, Prices & Attractions | Flyamba`;
  const description = `Find cheap flights to Florence, Italy from ${usdStr(LOWEST_SEK)}. Compare fares, plus complete English guides to attractions, restaurants, hotels, transport, weather, shopping, nightlife, family travel and Tuscan day trips.`;
...
function jsonLd() {
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Florence", item: url },
    ],
  };
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative isolate h-[80vh] min-h-[560px] w-full overflow-hidden">
        <SmartImage src={CITY.hero} alt="Cheap flights to Florence, Italy" fill priority sizes="100vw" className="object-cover" />

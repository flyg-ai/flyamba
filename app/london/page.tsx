  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section id="flights" className="mx-auto mt-10 max-w-7xl scroll-mt-32 px-4 sm:px-6 lg:px-8">
        ...
        <p className="mb-6 max-w-3xl text-muted-foreground">London is reachable from the US, the UK and across Europe, though whether a given route is non-stop depends on your airport and the season. Find cheap flights to London, compare airlines and book direct. Our AI flight search compares hundreds of routes to find you the cheapest flights to London — just describe your trip and Flyamba does the rest.</p>
        ...
        <NonstopRoutes slug="london" name="London" iata="LHR" />
      ...
      <section className="mx-auto mt-16 max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <h2 className="mt-2 font-serif text-3xl font-semibold text-foreground sm:text-4xl">Why Fly to London with Flyamba?</h2>
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {WHY.map((w) => (
